...
function(linux_unittests_add_exe whatIsBuilding)
    ...
    if(${run_valgrind})
        ...
        if(${VALGRIND_FOUND} STREQUAL VALGRIND_FOUND-NOTFOUND)
            ...
            set_tests_properties(${whatIsBuilding}_valgrind PROPERTIES TIMEOUT 3000)
            set_tests_properties(${whatIsBuilding}_helgrind PROPERTIES TIMEOUT 3000)
            set_tests_properties(${whatIsBuilding}_drd      PROPERTIES TIMEOUT 3000)
        endif()
    endif()
endfunction()
