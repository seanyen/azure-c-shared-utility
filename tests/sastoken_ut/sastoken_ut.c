...
TEST_FUNCTION(SASToken_Create_null_keyName_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(uint64_tToString(IGNORED_ARG, sizeof(TEST_TOKEN_EXPIRATION_TIME), TEST_EXPIRY)).IgnoreArgument(1).CopyOutArgumentBuffer(1, TEST_TOKEN_EXPIRATION_TIME, sizeof(TEST_TOKEN_EXPIRATION_TIME));
    ...
    STRICT_EXPECTED_CALL(STRING_concat(TEST_TOBEHASHED_HANDLE, IGNORED_ARG));
    ...
    STRICT_EXPECTED_CALL(HMACSHA256_ComputeHash(IGNORED_ARG, TEST_LENGTH_DECODEDKEY, IGNORED_ARG, TEST_LENGTH_TOBEHASHED, TEST_HASH_HANDLE)).IgnoreArgument(1).IgnoreArgument(3);
    ...
    STRICT_EXPECTED_CALL(STRING_concat(TEST_RESULT_HANDLE, IGNORED_ARG));
...
TEST_FUNCTION(SASToken_Create_uint64_tToString_fails)
{
    ...
    STRICT_EXPECTED_CALL(uint64_tToString(IGNORED_ARG, sizeof(TEST_TOKEN_EXPIRATION_TIME), TEST_EXPIRY)).IgnoreArgument(1).CopyOutArgumentBuffer(1, TEST_TOKEN_EXPIRATION_TIME, sizeof(TEST_TOKEN_EXPIRATION_TIME)).SetReturn(-1);
...
TEST_FUNCTION(SASToken_Create_build_to_be_hashed_part1_fails)
{
    ...
    STRICT_EXPECTED_CALL(STRING_concat(TEST_TOBEHASHED_HANDLE, IGNORED_ARG)).SetReturn(1);
...
TEST_FUNCTION(SASToken_Create_HMAC256_fails)
{
    ...
    STRICT_EXPECTED_CALL(HMACSHA256_ComputeHash(IGNORED_ARG, TEST_LENGTH_DECODEDKEY, IGNORED_ARG, TEST_LENGTH_TOBEHASHED, TEST_HASH_HANDLE)).SetReturn(HMACSHA256_ERROR);
...
TEST_FUNCTION(SASToken_Create_building_token_concat_scope_fails)
{
    ...
    STRICT_EXPECTED_CALL(URL_Encode(TEST_BASE64SIGNATURE_HANDLE)).SetReturn(TEST_URLENCODEDSIGNATURE_HANDLE);
    STRICT_EXPECTED_CALL(STRING_copy(TEST_RESULT_HANDLE, "SharedAccessSignature sr="));
    STRICT_EXPECTED_CALL(STRING_concat(TEST_RESULT_HANDLE, IGNORED_ARG)).SetReturn(1);
...
TEST_FUNCTION(SASToken_CreateString_large_int_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(Azure_Base64_Decode(&TEST_CHAR_ARRAY[0])).SetReturn(TEST_DECODEDKEY_HANDLE);
    STRICT_EXPECTED_CALL(uint64_tToString(IGNORED_ARG, sizeof(TEST_TOKEN_EXPIRATION_TIME_LARGE), TEST_EXPIRY_LARGE)).IgnoreArgument(1).CopyOutArgumentBuffer(1, TEST_TOKEN_EXPIRATION_TIME_LARGE, sizeof(TEST_TOKEN_EXPIRATION_TIME_LARGE));
